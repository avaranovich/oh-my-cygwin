...
Install [cygwin](http://www.cygwin.com/) with wget (check wget in the installation process) then start cygwin and execute 
    ...
    wget --no-check-certificate https://raw.githubusercontent.com/avaranovich/oh-my-cygwin/master/oh-my-cygwin.sh -O - | sh
...
This is forked and updated project from [haithembelhaj](https://github.com/haithembelhaj/oh-my-cygwin/) with small edits
